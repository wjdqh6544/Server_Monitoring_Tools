...
int get_File_Information(FileInfo** fileInfo, int* notNeedCnt, int* needCnt, int* failedCnt);
...
int get_IFA_Speed(DockerInfo** containerInfo, IFASpeed** ifa, int* ifaCount, int* containerCnt, int converted);
